...
kmeans = joblib.load(r'C:\Users\palhr\OneDrive\Desktop\Pgdba Projects\Customer Segmentation\kmeans_model.pkl')
scaler = joblib.load(r'C:\Users\palhr\OneDrive\Desktop\Pgdba Projects\Customer Segmentation\scaler.pkl')
...
num_web_visits = st.number_input("Number of Web Vists per Month", min_value=0, max_value=50, value=3)
